...
const DepositApp = dynamic(() => import('./DepositApp'), {
  ssr: false,
  loading: () => (
    <div className="grid min-h-screen place-items-center bg-[#07080a] px-6 text-center text-white">
      <div>
        ...
        <p className="mt-3 text-sm text-zinc-400">Preparing Reown AppKit deposit flow.</p>
      </div>
    </div>
  ),
})

export default function DepositShell() {
  return <DepositApp />
}
